...
- **Detection AP**: Train a detector (CenterPoint, BEVFormer) on sim data, evaluate on real data (and vice versa). The AP delta is the domain gap.
...
> **Open question:** What is the current detection AP gap when training CenterPoint on SplatAD-rendered nuScenes vs. real nuScenes? This is our Phase 1 target measurement.
